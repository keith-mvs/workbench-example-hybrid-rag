...
| RCT-011 | Re-establish `code/governance/` scaffold (un-RCT-001 per ADR-011) | open | P0 | claude | 2026-05-07 | 2026-05-07 | RCT-001 deleted these files under ADR-007; ADR-011 walks that back. v0.10.0+ ports the apexlon patterns into this repo. |
| RCT-012 | Port apexlon's 5-dimension OECD scorer into `code/governance/` | open | P0 | claude | 2026-05-07 | 2026-05-07 | dimensions/{auditability,transparency,robustness,fairness,reproducibility}.py + scorer.py composer. Adapt rules from prompt-artifact-scoring to lesson-output-scoring. v0.10.0. |
