...
| RCT-008b | Server-side check-changelog GitHub Action | open | P3 | claude | 2026-05-07 | 2026-05-07 | Mirror the client-side pre-commit hook for contributor commits. Deferred until repo has a CI surface. |
